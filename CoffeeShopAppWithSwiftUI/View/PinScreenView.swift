    ...
    var body: some View {
        VStack(spacing:0){
            ...
            VStack(spacing:20){
                ...
                HNavLinkWithEmojiText(title: state.isPinAvailable != "" ? "Change Pin" : "Create New Pin", pathName: state.isPinAvailable != "" ? "/profile/security/pin_screen/change_pin" : "/profile/security/pin_screen/new_pin", enableCaption: false, isPaddingActive: false, showEmoji: false)
